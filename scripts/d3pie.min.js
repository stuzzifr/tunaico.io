...
var labels = {
	...
	addLabelLines: function(pie) {
		var lineGroups = pie.svg.insert("g", "." + pie.t + "pieChart") // meaning, BEFORE .pieChart
	...
	fadeInLabelsAndLines: function(pie) {
		...
		setTimeout(function() {
			var labelFadeInTime = (pie.options.effects.load.effect === "default") ? 800 : 1; // 400 is hardcoded for the present
